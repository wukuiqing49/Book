package com.zia.widget.reader.anim;
...
public class CoverPageAnim extends HorizonPageAnim {
    ...
    public CoverPageAnim(int w, int h, View view, OnPageChangeListener listener) {
        ...
        belowRect = new Rect(0, 0, mViewWidth, mViewHeight);
        int[] mBackShadowColors = new int[] { 0x46000000,0x00000000};
    ...
    public void drawMove(Canvas canvas) {
        ...
        switch (mDirection){
            case NEXT:
                ...
                mDestRect.right = dis;
                canvas.drawBitmap(mNextBitmap, belowRect, belowRect,null);
            ...
            default:
                ...
                belowRect.left = (int) mTouchX;
                canvas.drawBitmap(mCurBitmap, belowRect, belowRect,null);
    ...
    public void addShadow(int left, Canvas canvas) {
        mBackShadowDrawableLR.setBounds(left, 0, left + 20 , mScreenHeight);
